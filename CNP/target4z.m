...
legend({[num2str(rtarget4z(1)*100), '%, supported by  500 Gt'], [num2str(rtarget4z(2)*100), '%, supported by 360 Gt'],...
     [num2str(rtarget4z(3)*100), '%, supported by 51 Gt'],...
     [num2str(rtarget4z(4)*100), '%, supported by 36 Gt']}, ...
...
legend({
    [num2str(round(Qtarget4z(1))), ' Gt'],[num2str(round(Qtarget4z(2))), ' Gt'],...
    [num2str(round(Qtarget4z(3))), ' Gt'],[num2str(round(Qtarget4z(4))), ' Gt']}, ...
    'Box', 'off',  'fontsize', 12,... 
