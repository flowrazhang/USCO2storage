...
% current growth rate
w =0.152439003;
start_q = 359.2/1000; % cumulative storage in 2030 = P(2030)-> known 1  
start_qt = 33.64/1000; % storage rate in 2030 = Q(2030) in Gt -> known 2 
target_year = 2050; % t2050
target_s = [0.769]; %storage rate in 2050 = Q(2050) i.e. 298 Mt/year in 2050 1.5Tech target -> known 3 
