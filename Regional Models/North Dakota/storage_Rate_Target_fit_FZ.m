...
% current growth rate
w =0.025318241;
start_q = 454.98/1000; % cumulative storage in 2030 = P(2030)-> known 1  
start_qt = 16.78/1000; % storage rate in 2030 = Q(2030) in Gt -> known 2 
target_year = 2050; % t2050
target_s = [0.032]; %storage rate in 2050 = Q(2050) i.e. 298 Mt/year in 2050 1.5Tech target -> known 3 
