...
% rate change
rtarget = [0.13857, 0.152];
% resulting storage to meet 2100 target
Qtarget =[152.2459, 11.9473];
% resulting peak injection
peak_target = [2081.4 2060];
...
plot(2050, 0.265, '.r', 'markersize', 12,'HandleVisibility','off')
...
legend({['265 Mt/yr, Mideastern Hub']}, ...
