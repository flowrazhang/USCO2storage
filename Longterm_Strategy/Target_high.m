...
% rate change
rtargetmedium = [0.11432, 0.11456, 0.1284, 0.188464061]; %  Low land 5.5 Gt 0.138
% resulting storage to meet 2100 target

Qtargetmedium =[506.3212,360.9020, 50.4575, 314.5027]; % mod 506, 366, 50.6, 36.6 - obs 497.6503, 350.4581, 50.8073, 36.8461
% resulting peak injection
peak_targetmedium = [2084.8, 2081.7, 2060.5, 2060.8];% 2056
...
text(2070,5000, 'High', 'fontsize', 14, 'FontWeight', 'bold')
...
for i=1:length(Qtargetmedium)
    ...
    plot(x2,yrate2, 'color', springcc(i+1,:))
end
...
plot(2050, 1.04, '.r', 'markersize', 16,'HandleVisibility','off')
...
text(2075,22.1, 'High', 'fontsize', 14, 'FontWeight', 'bold')